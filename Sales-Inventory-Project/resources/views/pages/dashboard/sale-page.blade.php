    ...
    <script>
        (async () => {
            try {
                ...
                errorToast('Error loading customers or products');
            }
        })()
        ...
        async function CustomerList() {
            ...
            $('#customerTable').on('click', '.addCustomer', function() {
        ...
        async function ProductList() {
            ...
            res.data.data.forEach(function(item, index) {
                let row = `<tr class="text-xs">
                        <td> <img class="w-10" src="/storage/${item['img_url']}"/> ${item['name']} ($ ${item['price']})</td>
            ...
            // Use event delegation
            $('#productTable').on('click', '.addProduct', function() {
