    ...
    <nav class="navbar sticky-top shadow-sm navbar-expand-lg navbar-light py-2">
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="header01">
                <ul class="navbar-nav ms-auto mt-3 mt-lg-0 mb-3 mb-lg-0 md-4">
                    <li class="nav-item md-4"><a class="nav-link" href="#">About</a></li>
                    <li class="nav-item md-4"><a class="nav-link" href="#">Company</a></li>
                    <li class="nav-item md-4"><a class="nav-link" href="#">Services</a></li>
        ...
        <div class="container pt-2">
            <div class="row align-items-center mb-5">
                <div class="col-12 col-md-10 col-lg-5 mb-5 mb-lg-0">
                    ...
                    <div class="d-flex flex-wrap gap-3"><a class="btn bg-gradient-primary mb-2 mb-sm-0"
        ...
        <div class="container">
            <div class="row">
                <div class="col-12 col-lg-8 mx-auto text-center">
                    <span class="text-muted">Happy Client</span>
            ...
            <div class="row">
                ...
                <div class="col-12 col-md-6 col-lg-3 p-3">
                    <div class="card px-0 text-center">
                        <img class="card-img-top mb3 w-100" src="{{ asset('/images/man.jpg') }}" alt="">
                        <h5>Danny Bailey</h5>
                        <p class="text-muted mb-4">CEO &amp; Founder</p>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-12 col-lg-5 mb-5 mb-lg-0">
                    <h2 class="fw-bold mb-5">Reach Out us: Let's Connect and Explore Opportunities Together</h2>
                    <h4 class="fw-bold">Address</h4>
                    <p class="text-muted mb-5">Daffodil smart city, Dhaka, Bangladesh</p>
                    <h4 class="fw-bold">Contact Us</h4>
                    <p class="text-muted mb-1">hello@wirframes.org</p>
                    <p class="text-muted mb-0">0123234454</p>
                </div>
                <div class="col-12 col-lg-6 offset-lg-1">
                    <form action="#">
    ...
    <footer class="py-5 bg-light">
        <div class="container text-center pb-5 border-bottom">
            ...
            <ul class="d-flex flex-wrap justify-content-center align-items-center list-unstyled mb-4">
                <li><a class="link-secondary me-4" href="#"></a>About</li>
                <li><a class="link-secondary me-4" href="#"></a>Company</li>
                <li><a class="link-secondary me-4" href="#"></a>Services</li>
                <li><a class="link-secondary me-4" href="#"></a>Testimonials</li>
            </ul>
            <div>
        ...
        <div class="mb-5">
            <div class="controller">
                <p class="text-center">All rights reserved © To Soroar Jahan(2025)</p>
            </div>
        </div>
    </footer>
@endsection
